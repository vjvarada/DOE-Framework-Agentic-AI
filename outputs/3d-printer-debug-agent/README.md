...
**Just double-click:** `3d-printer-debug-agent.code-workspace`
...
Then select **"3D Printer Debug Agent"** from the Copilot Chat agent dropdown and start working!
...
3. **Select your agent** - Choose "3D Printer Debug Agent" from the agent dropdown
...
```
3D Printer Debug Agent/
├── 3d-printer-debug-agent.code-workspace # ← Double-click to open VS Code!
