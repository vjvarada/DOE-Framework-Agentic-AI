# Indian Legal Compliance Agent - Automated Setup Script
# Run this script to set up the agent environment from scratch
# Usage: .\setup.ps1

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Setting up: Indian Legal Compliance Agent" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  3. Select 'Indian Legal Compliance Agent' from Copilot Chat agent dropdown" -ForegroundColor White
Write-Host ""
