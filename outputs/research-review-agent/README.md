...
Creates comprehensive state-of-the-art review papers on research topics by searching, fetching, and synthesizing academic papers

## 🚀 Instant Start

**Just double-click:** `research-review-agent.code-workspace`
...
Then select **"Research Review Agent"** from the Copilot Chat agent dropdown and start working!
...
3. **Select your agent** - Choose "Research Review Agent" from the agent dropdown
...
```
Research Review Agent/
├── research-review-agent.code-workspace # ← Double-click to open VS Code!
...
- [Research Paper Review](directives/research_paper_review.md)
